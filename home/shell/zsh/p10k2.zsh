# Generated by Powerlevel10k configuration wizard on 2026-06-09 at 16:18 CEST.
...
() {
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  # typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=61 # Dark Blue 
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=110 # Light Blue
  # Custom icon.
